...
export default function MainNavbar() {
    ...
    const [listOfMusics, setListOfMusics] = useState([
        ...
        {title:"System Of Downn - lonelyday.mp3", src:`${lonelyday}`, totalDurationInSeconds: 171.061406},
        {title:"Lynyrd Skynyrd - simpleman.mp3", src:`${simpleman}`, totalDurationInSeconds: 359.607438}
    ...
    useEffect(()=>{
        ...
        */
        ...
        const musicRenderer = (indexOfCurrentMusic) => {
          console.log('indexOfCurrentMusic :>>', indexOfCurrentMusic);
...
<>
    <nav id="navbar-container" ref={navRef} >
        ...
        <audio id="audioPlayer" src={lonelyday}></audio>
